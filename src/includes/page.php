...
class Page
{
     ...
     */
    public function Page($each_disNums, $nums, $current_page, $sub_pages)
    {
        ...
        $temp               = str_replace('&page=' . $this->current_page, '', $temp);
        $temp               = str_replace('?page=' . $this->current_page, '', $temp);
        $this->subPage_link = $temp . "&page=";
    }
    /**
     * 照顾低版本
     */
    ...
    public function show()
    {
        ...
        for ($i = 0; $i < count($a); $i++) {
            ...
            if ($s == $this->current_page) {
                $str .= '<li class="active"><a href="javascript:;">' . $s . '</a></li>';
            } else {
